...
/// The event name
@property (nonatomic, readonly, copy) NSString * _Null_unspecified event SWIFT_DEPRECATED_OBJC("Swift property 'Message.event' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// The publisher of the event
@property (nonatomic, readonly, copy) NSString * _Null_unspecified from SWIFT_DEPRECATED_OBJC("Swift property 'Message.from' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// A dictionary containig the message
@property (nonatomic, readonly, strong) id _Nullable data SWIFT_DEPRECATED_OBJC("Swift property 'Message.data' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
